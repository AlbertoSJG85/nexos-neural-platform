    ...
    <nav className="fixed top-0 w-full z-[100] px-6 py-8">
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-12">
          {['Ecosistema', 'Arquitectura', 'Seguridad'].map(item => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 hover:text-white transition-colors relative group">
              {item}
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-4 px-8 py-3.5 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 text-white text-[12px] font-black tracking-widest rounded-full shadow-lg transition-all"
        >
